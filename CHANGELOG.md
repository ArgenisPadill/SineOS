# Changelog
- Recuperado el volumen externo InfoDGRC tras una desconexión USB durante TD-021: reparación mediante Windows Recovery en QEMU/KVM, montaje NTFS normal restaurado y repositorio Restic revalidado sin errores.
- Cerrado TD-003: backup lógico PostgreSQL validado mediante SHA-256 y restauración real en una instancia PostgreSQL 18 temporal aislada; roles y estructura verificados, entorno temporal eliminado y producción intacta.
